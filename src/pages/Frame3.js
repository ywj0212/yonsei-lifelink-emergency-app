              ...
              <div className={styles.groupParent}>
                ...
                <div className={styles.parent}>
                  ...
                  <div
                    ...
                    onClick={() => setBreathDepth('shallow')}
                    style={
                      breathDepth === 'shallow'
                        ? { backgroundColor: '#ff7979' }
                        : { backgroundColor: '#e2e2e2' }
            ...
            <div className={styles.cParent}>
              ...
              <div className={styles.groupContainer}>
                ...
                <div className={styles.container}>
                  ...
                  />
                  <div
                    className={`${styles.div5} ${styles.bloodpress_high}`}
                    style={{ backgroundColor: 'transparent' }}
                    onClick={() => setBloodPressure('고혈압')}
                  >
                    고혈압
                  ...
                  <div
                    className={`${styles.div6} ${styles.bloodpress_normal}`}
                    style={{ backgroundColor: 'transparent' }}
                    onClick={() => setBloodPressure('정상')}
                  >
                    정상
                  ...
                  <div
                    className={`${styles.div7} ${styles.bloodpress_low}`}
                    style={{ backgroundColor: 'transparent' }}
                    onClick={() => setBloodPressure('저혈압')}
                  >
                    저혈압
                ...
                <div className={styles.parent1}>
                  ...
                  />
                  <div
                    className={`${styles.div9} ${styles.pulse_low}`}
                    style={{ backgroundColor: 'transparent' }}
                    onClick={() => setBeat('빈맥')}
                  >
                    빈맥
                  ...
                  <div
                    className={`${styles.div6} ${styles.pulse_normal}`}
                    style={{ backgroundColor: 'transparent' }}
                    onClick={() => setBeat('정상')}
                  >
                    정상
                  ...
                  <div
                    className={`${styles.div11} ${styles.pulse_high}`}
                    style={{ backgroundColor: 'transparent' }}
                    onClick={() => setBeat('서맥')}
                  >
                    서맥
            ...
            <div className={styles.dParent}>
              ...
              <div className={styles.rectangleGroup}>
                ...
                <div
                  ...
                  onClick={() => setConsciousness('semicoma')}
                  style={
                    consciousness === 'semicoma'
                      ? { backgroundColor: '#ff7979' }
                      : { backgroundColor: '#e2e2e2' }
                  }
                />
                <div
                  className={styles.semicoma}
                  style={{ backgroundColor: 'transparent' }}
                  onClick={() => setConsciousness('semicoma')}
                >
                  semicoma
                ...
                <div
                  ...
                  onClick={() => setConsciousness('stupor')}
                  style={
                ...
                <div
                  ...
                  onClick={() => setConsciousness('alert')}
                  style={
                    consciousness === 'alert'
                      ? { backgroundColor: '#ff7979' }
                      : { backgroundColor: '#e2e2e2' }
                ...
                <div
                  ...
                  onClick={() => setConsciousness('drowsy')}
                  style={
